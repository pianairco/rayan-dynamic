...
<%@ page import="ir.rayan.data.sql.SQLManager" %>
...
<tr>
    <td>
        <%
            if(SQLManager.getSQLManager().isPersistDef(formDef.getQueryName())) {
        %>
        ...
        <%
            } else if(SQLManager.getSQLManager().isSelectQuery(formDef.getQueryName())) {
        %>
